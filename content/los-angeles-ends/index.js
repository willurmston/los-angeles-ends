    ...
    slides: [
        ...
        },
        {
            ...
            markdown: `
                ...
                i think about childhood nightmares of nuclear bombs exploding on the horizon, of knowing the end is soon and near but not right now or quite yet here. i think about miracle mile, a movie that my parents showed me when i was too young to process death properly, where missiles come flying over the santa monica mountains and land in the la brea tar pits. i think about the episode of 24 where jack bauer cries as a mushroom cloud rises over valencia.
...
i wake up in a sweat. it's my fault — it wouldn’t have happened if i hadn’t looked.
        ...
        },
        {
            type: 'narration',
            markdown: `
                also in 2016, my dad wrote a short story following an eye surgery that split his vision, temporarily, in two. in it, los angeles ends, downtown disappearing in an orange burst. we never spoke to each other about what we were working on.
            `
        },
        {
            type: 'quote',
